...
//MOTION SENSOR SETUP
  ...
  rest.function("username",setUser);
  rest.function("password",setPass);
...
int setUser(String command) {
  
  int spacedex = command.indexOf(" ");
  String output = command.substring(0, spacedex);
  rest.set_name(output);
