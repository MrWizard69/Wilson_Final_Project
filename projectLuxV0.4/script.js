...
function logcheck(){
	...
	console.log(loc);
	//window.location.href = window.location.origin + "/#logged";
    	...
    	$('#regiBtn').click(function() { //when the button is clicked...
			...
			if(data.id === prodid) 
				{ 
					...
					url = "http://192.168.2.10/username?params=" + username;
    				...
    				url = "http://192.168.2.10/password?params=" + pass;
...
//LOGIN FUNCTION 
$(function() {
    	$('#logBtn').click(function() { //when the button is clicked...
...
////////////////////////////////////////////////////////////////////////////////////
//DIM/BRIGHTEN LIGHT BUTTON FUNCTION 
$(function() {
...
////////////////////////////////////////////////////////////////////////////////////
//DIM/BRIGHTEN BACK BUTTON FUNCTION 
$(function() {
